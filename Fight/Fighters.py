...
class XiaoChi(Team):
    def __init__(self):
        ...
        self.SetPokemons(['乘龙','妙蛙花','喷火龙','水箭龟','卡比兽','皮卡丘'])
        self.SetPokemonsSkills([['泰山压顶','暴风雪','精神强念','冲浪'],['催眠粉','污泥攻击','日光束','超级吸取'],['喷射火焰','劈开','翅膀攻击','火焰旋涡'],['暴风雪','冲浪','火箭头锤','水炮'],['地震','泰山压顶','睡觉','破坏光线'],['电光一闪','十万伏特','打雷','电电加速']])
